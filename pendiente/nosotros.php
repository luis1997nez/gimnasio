  ...
  <header>
    ...
    <section class="ftco-about d-md-flex">
    	...
    	<div class="one-half ftco-animate">
	        ...
	        <div>
	  				<p>El Café, un restaurante inspirado en las tradicionales cafeterías del Puerto de Veracruz.
					   Siempre se pensó que algo similar le hacía falta a Cancún, en ese entonces todo estaba dirigido a los turistas, no había nada pensado en gente local.
					   En 2014 abrimos el restaurante que oficialmente se llamaba Coffee&Food, con la idea que con el tiempo alcanzáramos nuestra propia identidad.
					   Sirviendo siempre a nuestros comensales el mejor café de Cancún.</p>
	  			</div>
  			</div>
    	</div>
    </section>
